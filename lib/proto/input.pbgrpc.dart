...
class InputMethodsClient extends $grpc.Client {
  static final _$pressKey = $grpc.ClientMethod<$0.Key, $0.Key>(
  ...
  $grpc.ResponseFuture<$0.Key> pressKey($0.Key request,
      {$grpc.CallOptions? options}) {
...
abstract class InputMethodsServiceBase extends $grpc.Service {
  ...
  InputMethodsServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Key, $0.Key>(
        'PressKey',
        pressKey_Pre,
        false,
        false,
  ...
  $async.Future<$0.Key> pressKey_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Key> request) async {
    return pressKey(call, await request);
  }

  $async.Future<$0.Key> pressKey($grpc.ServiceCall call, $0.Key request);
}
